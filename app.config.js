    ...
    expo: {
      ...
      plugins: [
        ...
        [
          ...
          {
            photosPermission:
              "Allow $(PRODUCT_NAME) to access your photos to share the images you select with other people that have access to the project.",
          },
        ],
        "expo-router",
        [
          ...
          {
            contactsPermission:
              "Allow $(PRODUCT_NAME) to access your contacts to select people you want to share a project with.",
          },
        ],
        [
          "expo-camera",
        ...
        [
          ...
          {
            calendarPermission:
              "Allow $(PRODUCT_NAME) to access your calendar to put events from projects you create into your calendar.",
          },
        ],
        [
